...
<% 
	...
	LOCATION <input type="text" name="location" value="<%= plocation%>" readonly> <br>
	PRICE <input type="number" name="price" value="<%= pprice%>" readonly> <br>
	TYPE <input type="text" name="type" value="<%= ptype%>" readonly> <br>
	FEATURES <input type="text" name="features" value="<%= pfeatures%>" readonly> <br>
	
	<input type="submit" name="submit" value="deleteproperty">
	</form>
